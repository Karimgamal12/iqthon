...
from Arab import StartTime, sourceav, catversion
...
sourceavPC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/56d1760224589ee370186.jpg"
...
IQPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/56d1760224589ee370186.jpg"
...
async def iq(sourceavevent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "𝗐𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝖾𝗅𝖾𝗍𝗁𝗈𝗇 Avter𓃠"
    sourceav_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/56d1760224589ee370186.jpg"
...
async def amireallyalive(event):
    ...
    sourceav_ALIVE_TEXT = "❬ تـليثون افاتار T
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , """🝳︙ جـاري تـحديث تيلثون افاتار(8.8)
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlinesourceav(sourceav):
        ...
        query = sourceav.text
        await bot.get_me()
        if query.startswith("تنصيب") and sourceav.query.user_id == bot.uid:
            ...
            if sourceavPC and sourceavPC.endswith((".jpg", ".png", "gif", "mp4")):
                result = builder.photo(sourceavPC, text=help1, buttons=buttons, link_preview=False)
            elif sourceavPC:
                result = builder.document(sourceavPC,title="sourceav",text=help1,buttons=buttons,link_preview=False)
            else:
                result = builder.article(title="sourceav",text=help1,buttons=buttons,link_preview=False)
...
https://t.me/avTar_So/36
  • لتغير صوره او فيديو امر الفحص اضغط هنا ↶
https://t.me/avTar_So/39
  • لتغير كليشة امر حماية الخاص اضغط هنا ↶
https://t.me/avTar_So/35
  • لوضع صوره او فيديو حماية الخاص اضغط هنا ↶
https://t.me/avTar_So/38
  • لتغير عدد تحذيرات حماية الخاص اضغط هنا ↶
https://t.me/avTar_So/45
  • لتغير نبذه الوقتيه اضغط هنا ↶
https://t.me/avTar_So/54
  • لتغير صوره وقتيه اضغط هنا ↶
 https://t.me/avTar_So/46 
  • لتغير خط زخرفه اسم وقتي اضغط هنا ↶
 https://t.me/avTar_So/59
  •  لوضع ايموجي بجانب اسم وقتي اضغط هنا ↶
 https://t.me/avTar_So/37
• لتغير امر من الاوامر اضغط هنا ↶
https://t.me/Help_Tele_Av/4718
• لكيفيه حذف الفار اضغط هنا ↶
https://t.me/avTar_So/51
———————×——————— 
قناه المتغيرات او الفارات : @avTar_So
شرح الأوامر : ( @Help_Tele_Av ) .
قناه السورس : ( @sourceav ) .
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/Help_Tele_Av/4704 
قناه السورس : ( @sourceav ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/Help_Tele_Av/4705
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/Help_Tele_Av/4721  ⦒
""")
...
async def inlinesourceav(sourceav):
    ...
    await sourceav.edit(text, buttons=buttons)
@sourceav.on(admin_cmd(pattern="تحميل الملف(?: |$)(.*)"))    
async def install(event):
    if event.reply_to_msg_id:
        try:
            downloaded_file_name = await event.client.download_media(await event.get_reply_message(), "sourceav/plugins/")
...
async def inlinesourceav(sourceav):
    ...
    await sourceav.edit(text, buttons=buttons)
@sourceav.on(admin_cmd(pattern="مسح الملف(?: |$)(.*)"))    
async def unload(event):
    shortname = event.pattern_match.group(1)
    path = Path(f"sourceav/plugins/{shortname}.py")
...
@sourceav.on(admin_cmd(pattern="هاش ([\s\S]*)"))    
...
async def inlinesourceav(sourceav):
    ...
    await sourceav.edit(text, buttons=buttons)
@sourceav.on(admin_cmd(pattern="هاش(ين|دي) ([\s\S]*)"))    
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlinesourceav(sourceav):
        ...
        if query.startswith("(صيانه|صيانه)") and sourceav.query.user_id == bot.uid:
            try:
                buttons = [[Button.inline("اوامر السورس", data="order1"), Button.inline("اوامر الحساب", data="ord1hs"),],[Button.inline("اوامر الكروب", data="ord1G"), Button.inline("اوامر الالعاب", data="ord1pl"),],[Button.inline("اوامر الصيغ", data="ordsag1"), Button.inline("اوامر الاغاني", data="ordSONG"),], [Button.inline("اسم وقتي", data="order13"), Button.inline("اوامر الاعلانات", data="ordahln1"),],[Button.inline("اوامر التسليه", data="order14"),],[Button.inline("الفارات", data="ordvars"),]]
                result = builder.article(title="sourceav",text=help2,buttons=buttons,link_preview=False)
                await sourceav.answer([result] if result else None)
...
async def reposourceav(sourceav):
    ...
    await response[0].click(sourceav.chat_id)
    await sourceav.delete()
@sourceav.on(admin_cmd(pattern="فتح همسه(?: |$)(.*)"))    
async def iq(event):
