...
try:
    LOGS.info("بدء تنزيل تليثون اڤتار")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["sourceav","avTar_So","Help_Tele_Av","UIU_II","va_source"]
    ...
    print(f"<b> 🔱 اهلا بك لقد نصبت تليثون اڤتار بنجاح ☸️ اذهب الى قناتنا لمعرفة المزيـد 🔆. </b>\n CH : https://t.me/sourceav ")
    await verifyLoggerGroup()
